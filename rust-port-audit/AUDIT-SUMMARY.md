...
- **CI (F144/RELEASE):** `.github/workflows/ci.yml` added — fmt, build, clippy, and `cargo test --workspace --no-fail-fast` on Linux/macOS/Windows using the pinned `rust-toolchain.toml` (1.97.1).
