...
- `cargo fmt --all -- --check` passes. The conservative score is **103/155 (66.5%)** after the 2026-08-18 re-audit promotions (7 + 14 + 8 verified PARTIAL rows).
...
- Conservative connected score: **103/155 (66.5%)**; the inventory contains additional partial/connected subfeatures that are not counted as fully equivalent.
- IMPLEMENTED_CONNECTED: **103** (66%)
